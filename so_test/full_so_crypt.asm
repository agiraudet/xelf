...
; This is the decryption routine. It needs to be uncommented once we have add the ET_DYN code first, so that 0xCCCCCCCCCCCCCCCC will hold the correct address
; aka (address_of_begining_of_program + 0xCCCCCCCCCCCCCCCC)
; 
; mov ecx, 0xFB
